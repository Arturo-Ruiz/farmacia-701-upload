...
<body class="bg-light container">
    <nav class="navbar navbar-light bg-light">
        <div class="container-fluid">
            <a class="navbar-brand fs-6 text-primary" href="{{route('inicio.dolares')}}"> <i class="fa-solid fa-reply"></i> Volver a la
                tienda </a>
        </div>
    </nav>
    ...
    <section class="">
        ...
        <main class="row">
            ...
            <div class="info col-md-5 mt-md-5 py-md-5">
                ...
                <form method="POST" action="{{ route('cartSaveDollars') }}">
                    @csrf
    ...
    <script src="{{ asset('js/main_dollars.js') }}"></script>
